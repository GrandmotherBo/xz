/*class ResistLogger
{
    ...
    private string              m_FolderSoPath = "RadiationsXZoneLogsResist";
    ...
    void ResistLogger()
    {
        ...
        FPrintln(m_LogFile, "====================================Resist Radiations Logs=====================================");
        CloseFile(m_LogFile);
    }
    ...
    string CreateName()
    {
        ...
        result = string.Format("ResistRadiations(%1_%2_%3_%4_%5).log",year, month, day, hour, minute);
        return result;
    }
...
ref ResistLogger g_ResistLogger;